...
// SERVICES DATA - WITH WORKING IMAGES
const services = [
  { name: "Makeup", desc: "Professional makeup for all occasions", img: "https://images.pexels.com/photos/3993449/pexels-photo-3993449.jpeg?auto=compress&w=500" },
  { name: "Bridal Makeup", desc: "Stunning bridal looks for your big day", img: "https://images.pexels.com/photos/3783055/pexels-photo-3783055.jpeg?auto=compress&w=500" },
  { name: "Hair Styling", desc: "Trendy cuts, colors & styling", img: "https://images.pexels.com/photos/3992650/pexels-photo-3992650.jpeg?auto=compress&w=500" },
  { name: "Facial Treatments", desc: "Glowing skin with premium facials", img: "https://images.pexels.com/photos/3757959/pexels-photo-3757959.jpeg?auto=compress&w=500" },
  { name: "Skin Care", desc: "Personalized skin care solutions", img: "https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&w=500" }
];
...
function renderServices() {
  ...
  grid.innerHTML = services.map(service => `
    <div class="service-card">
      <div class="service-img" style="background-image: url('${service.img}'); background-size: cover; background-position: center;"></div>
...
const galleryImages = [
  ...
  "https://images.pexels.com/photos/3992650/pexels-photo-3992650.jpeg?auto=compress&w=400",
  "https://images.pexels.com/photos/3757959/pexels-photo-3757959.jpeg?auto=compress&w=400",
